...
interface OpportunitiesPageProps {
  onBookSlot: (opportunityId: number) => void;
}
...
export function OpportunitiesPage({ onBookSlot }: OpportunitiesPageProps) {
  ...
  const filterOpportunities = () => {
    return opportunities.filter((opp) => {
      const durationMatch = selectedDuration === 'all' || opp.duration.includes(selectedDuration);
      const skillMatch = selectedSkill === 'all' || opp.skills.includes(selectedSkill);
      const ngoMatch = selectedNGO === 'all' || opp.ngo === selectedNGO;
          ...
          {filteredOpportunities.map((opportunity) => (
            ...
            >
              <div className="p-6">
                ...
                <div className="text-sm text-blue-600 mb-4">{opportunity.ngo}</div>
                ...
                <Button
                  ...
                  onClick={() => onBookSlot(opportunity.id)}
                >
                  Book Slot
                </Button>
              </div>
